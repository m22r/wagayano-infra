...
output "aws_access_key_id_for_doberman_ci" {
  value = module.doberman_ci_user.id
}
output "aws_secret_access_key_for_doberman_ci" {
  value = module.doberman_ci_user.secret
}
